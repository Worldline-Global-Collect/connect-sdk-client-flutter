...
part of 'validation_rule_resident_id_number.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ValidationRuleResidentIdNumber _$ValidationRuleResidentIdNumberFromJson(
...
Map<String, dynamic> _$ValidationRuleResidentIdNumberToJson(
        ValidationRuleResidentIdNumber instance) =>
    <String, dynamic>{
