...
part of 'payment_product_group.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

PaymentProductGroup _$PaymentProductGroupFromJson(Map<String, dynamic> json) {
  $checkKeys(
    json,
...
Map<String, dynamic> _$PaymentProductGroupToJson(
        PaymentProductGroup instance) =>
    <String, dynamic>{
